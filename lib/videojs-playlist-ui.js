...
const removeSelectedClass = function(el) {
  ...
  let thumbnail = el.$('.vjs-playlist-thumbnail');
  if (thumbnail) {
    videojs.removeClass(thumbnail, 'vjs-playlist-now-playing');
  }
}
...
class PlaylistMenuItem extends Component {
  ...
  createEl() {
    ...
    // Thumbnail image
    let thumbnail = createThumbnail(item.thumbnail);
    ...
    videojs.on(li, ['focus', 'mouseover'], function() {
      videojs.addClass(thumbnail, 'vjs-icon-play');
      videojs.removeClass(thumbnail, 'vjs-playlist-now-playing');
    });
    videojs.on(li, ['blur', 'mouseout'], function() {
      videojs.removeClass(thumbnail, 'vjs-icon-play');
      if (videojs.hasClass(li, 'vjs-selected')) {
